...
/* harmony import */ var _Partials_ManageHomePage_EditItem__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(5604);
/* harmony import */ var _Partials_ManageHomePage_ViewItem__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(4321);
...
/* harmony import */ var system_format__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(7535);
...
const EditItem = ({
  ...
  const onSubmit = async query => {
    setLoading(true);
    const id = (dataValues === null || dataValues === void 0 ? void 0 : dataValues.id) || 1;
    const {
      data,
      error
  ...
  const articlesOptions = articles === null || articles === void 0 ? void 0 : articles.map(element => ({
    value: element.id,
    label: element.title
  }));
  const selectedSlideOption = articlesOptions === null || articlesOptions === void 0 ? void 0 : articlesOptions.filter(element => {
    var _dataValues$slideIds;

    return (_dataValues$slideIds = dataValues.slideIds) === null || _dataValues$slideIds === void 0 ? void 0 : _dataValues$slideIds.includes(element.value);
  });
      ...
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)("form", {
        ...
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)("label", {
          ...
          children: [/*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx("span", {
            ...
            className: "mt-2"
          })), ((_errors$slideIds = errors.slideIds) === null || _errors$slideIds === void 0 ? void 0 : _errors$slideIds.message) && /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx("p", {
...
/* harmony import */ var _EditItem__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(5604);
...
/* harmony import */ var modules_admin_HomeActivity__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(7059);
...
var __webpack_exports__ = __webpack_require__.X(0, [2922,3061,9531,9682,967,8790,2077,3751,6133,3903,3800,6635], () => (__webpack_exec__(7916)));
