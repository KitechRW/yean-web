...
/* harmony import */ var modules_admin_Partials_ManageJobs_ViewItem__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(9077);
/* harmony import */ var modules_admin_Partials_ManageJobs_AddItem__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(6739);
...
const JobActivity = () => {
  ...
  react__WEBPACK_IMPORTED_MODULE_3___default().useEffect(() => {
    ...
    if (rows.length) {
      const matchJobs = rows.filter(element => element?.title ? element?.title?.toLowerCase().includes(filterValue.toLowerCase()) : false);
...
/* harmony import */ var system_config_richtext__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(6973);
...
const ReactQuill = next_dynamic__WEBPACK_IMPORTED_MODULE_7___default()(() => Promise.resolve(/* import() */).then(__webpack_require__.t.bind(__webpack_require__, 2586, 23)), {
  ssr: false,
  loadableGenerated: {
    modules: ["..\\modules\\admin\\_Partials\\ManageJobs\\AddItem\\index.tsx -> " + 'react-quill']
  }
});
    ...
    children: [children, /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx("div", {
      ...
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)("form", {
        ...
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)("label", {
          ...
          })), errors.title?.message && /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx("p", {
            className: "mt-1 text-red-500",
            children: (0,system_format__WEBPACK_IMPORTED_MODULE_10__/* .formatJoiErorr */ .a)(`${errors.title.message}`)
          })]
          ...
          children: [/*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx("span", {
            ...
            className: "mt-2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
          })), errors.keyword?.message && /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx("p", {
            className: "mt-1 text-red-500",
            children: (0,system_format__WEBPACK_IMPORTED_MODULE_10__/* .formatJoiErorr */ .a)(`${errors.keyword.message}`)
          })]
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)("label", {
          className: "flex flex-col",
          children: [/*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx("span", {
            ...
            className: "mt-2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
          })), errors.location?.location && /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx("p", {
            className: "mt-1 text-red-500",
            children: (0,system_format__WEBPACK_IMPORTED_MODULE_10__/* .formatJoiErorr */ .a)(`${errors.location.message}`)
          })]
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)("label", {
          className: "flex flex-col",
          children: [/*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx("span", {
            ...
            className: "mt-2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
          })), errors.category?.message && /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx("p", {
            className: "mt-1 text-red-500",
            children: (0,system_format__WEBPACK_IMPORTED_MODULE_10__/* .formatJoiErorr */ .a)(`${errors.category.message}`)
          })]
          ...
          }), /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx(ReactQuill, {
            theme: "snow",
            defaultValue: dataValues?.description,
            modules: system_config_richtext__WEBPACK_IMPORTED_MODULE_8__/* ["default"].modules */ .Z.modules,
            formats: system_config_richtext__WEBPACK_IMPORTED_MODULE_8__/* ["default"].formats */ .Z.formats,
            onChange: newValue => {
          ...
          }), errors.description?.message && /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx("p", {
            className: "mt-1 text-red-500",
            children: (0,system_format__WEBPACK_IMPORTED_MODULE_10__/* .formatJoiErorr */ .a)(`${errors.description?.message}`)
          })]
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)("div", {
          className: "flex items-center space-x-3 justify-between md:col-span-2",
          children: [dataValues ? /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx("button", {
            type: "button",
            disabled: loading,
            onClick: onDelete,
            ...
            children: "Delete"
          }) : null, /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx("button", {
            type: "submit",
            disabled: loading,
...
/* harmony import */ var _AddItem__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(6739);
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(6689);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var modules_admin_JobActivity__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(4009);
...
var __webpack_exports__ = __webpack_require__.X(0, [676,3061,9531,5152,6945,4653,8844,9391,637,3389,6673,1494,5377], () => (__webpack_exec__(3548)));
