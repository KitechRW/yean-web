...
/* harmony import */ var modules_admin_Partials_ManageServices_ViewItem__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(3124);
/* harmony import */ var modules_admin_Partials_ManageServices_AddItem__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(2496);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(997);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([apis_utils_fetcher__WEBPACK_IMPORTED_MODULE_2__, modules_admin_Partials_ManageServices_ViewItem__WEBPACK_IMPORTED_MODULE_4__, modules_admin_Partials_ManageServices_AddItem__WEBPACK_IMPORTED_MODULE_5__]);
([apis_utils_fetcher__WEBPACK_IMPORTED_MODULE_2__, modules_admin_Partials_ManageServices_ViewItem__WEBPACK_IMPORTED_MODULE_4__, modules_admin_Partials_ManageServices_AddItem__WEBPACK_IMPORTED_MODULE_5__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);
...
const ServiceActivity = () => {
  const [services, setServices] = react__WEBPACK_IMPORTED_MODULE_3___default().useState({
    count: 0,
    rows: []
  });
  const {
    ...
    isLoading
  } = (0,apis_utils_fetcher__WEBPACK_IMPORTED_MODULE_2__/* .useOpenFetcher */ .TB)(`/api/services`);
  ...
  react__WEBPACK_IMPORTED_MODULE_3___default().useEffect(() => {
    ...
    if (rows.length) {
      const matchservices = rows.filter(element => {
        var _element$name;

        return element !== null && element !== void 0 && element.name ? element === null || element === void 0 ? void 0 : (_element$name = element.name) === null || _element$name === void 0 ? void 0 : _element$name.toLowerCase().includes(filterValue.toLowerCase()) : false;
      });
      setServices(prev => _objectSpread(_objectSpread({}, prev), {}, {
        rows: matchservices
      }));
    }
  }, [data, filterValue]);
  ...
  const handleAdd = item => {
    setServices(prev => _objectSpread(_objectSpread({}, services), {}, {
      rows: [...prev.rows, item]
    }));
  };
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)("div", {
    ...
    children: [/*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx("h2", {
      ...
      }), /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx(modules_admin_Partials_ManageServices_AddItem__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .Z, {
        handleAdd: item => {
          handleAdd(item);
        },
      ...
      children: [services.rows.map((item, index) => {
        return /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx(modules_admin_Partials_ManageServices_ViewItem__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .Z, {
          data: item,
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ServiceActivity);
...
const schema = joi__WEBPACK_IMPORTED_MODULE_3___default().object({
  ...
  content: joi__WEBPACK_IMPORTED_MODULE_3___default().string().required()
});
...
const AddItem = ({
  ...
  var _errors$name, _errors$content, _errors$image, _errors$image2;
  ...
  const onSubmit = async query => {
    ...
    const {
      data,
      error
    } = await (!dataValues ? apis_restful__WEBPACK_IMPORTED_MODULE_1__/* ["default"].PostRoute.postRoute */ .Z.PostRoute.postRoute('/api/services', formData) : apis_restful__WEBPACK_IMPORTED_MODULE_1__/* ["default"].PatchRoute.patchRoute */ .Z.PatchRoute.patchRoute(`/api/services/${dataValues.id}`, formData));
    setLoading(false);
  ...
  const onDelete = async () => {
    ...
    const {
      data,
      error
    } = await apis_restful__WEBPACK_IMPORTED_MODULE_1__/* ["default"].DeleteRoute.deleteRoute */ .Z.DeleteRoute.deleteRoute(`/api/services/${dataValues.id}`);
    setLoading(false);
    ...
    children: [children, /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx("div", {
      ...
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsxs)("form", {
        ...
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsxs)("label", {
          ...
          })), ((_errors$content = errors.content) === null || _errors$content === void 0 ? void 0 : _errors$content.message) && /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx("p", {
            className: "mt-1 text-red-500",
            children: (0,system_format__WEBPACK_IMPORTED_MODULE_9__/* .formatJoiErorr */ .a)(`${errors.content.message}`)
          })]
...
/* harmony import */ var _AddItem__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(2496);
...
/* harmony import */ var modules_admin_ServiceActivity__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(289);
/* harmony import */ var system_lib_withSession__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(7154);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(997);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([modules_admin_ServiceActivity__WEBPACK_IMPORTED_MODULE_3__, system_lib_withSession__WEBPACK_IMPORTED_MODULE_4__]);
([modules_admin_ServiceActivity__WEBPACK_IMPORTED_MODULE_3__, system_lib_withSession__WEBPACK_IMPORTED_MODULE_4__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);
...
const Service = () => {
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.Fragment, {
    children: [/*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx((next_head__WEBPACK_IMPORTED_MODULE_1___default()), {
      ...
      children: /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx(modules_admin_ServiceActivity__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Z, {})
    })]
  });
};
...
var __webpack_exports__ = __webpack_require__.X(0, [2922,3061,9531,9682,967,8790,2077,3751,9663,6133,3903,3800,6635,4427], () => (__webpack_exec__(596)));
