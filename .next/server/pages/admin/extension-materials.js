...
/* harmony import */ var modules_activities_Partials_Partners_PartnerAdminView__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(5526);
/* harmony import */ var apis_utils_fetcher__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(5377);
/* harmony import */ var modules_activities_Partials_ExtensionMaterials_AddExtensionMaterials__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(7911);
...
const AdminExtenstionMaterialsActivity = () => {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    if (data.partners?.rows?.length) {
      const filteredPartner = data.partners?.rows?.filter(each => each.companyName.toLowerCase().includes(filterValue.toLowerCase()));
...
var restful = __webpack_require__(637);
...
/* harmony import */ var modules_activities_AdminExtenstionMaterialsActivity__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(4706);
...
var __webpack_exports__ = __webpack_require__.X(0, [676,3061,9531,6945,4653,8844,9391,637,1663,3389,6673], () => (__webpack_exec__(6587)));
