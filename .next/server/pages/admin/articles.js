...
/* harmony import */ var _Partials_ManageArticle_AddItem__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(2878);
/* harmony import */ var _Partials_ManageArticle_ViewItem__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(2645);
...
const ArticleActivity = () => {
  ...
  react__WEBPACK_IMPORTED_MODULE_4___default().useEffect(() => {
    ...
    if (rows.length) {
      const matcharticles = rows.filter(element => {
        var _element$title, _element$title$toLowe;

        return (_element$title = element.title) === null || _element$title === void 0 ? void 0 : (_element$title$toLowe = _element$title.toLowerCase()) === null || _element$title$toLowe === void 0 ? void 0 : _element$title$toLowe.includes(filterValue.toLowerCase());
      });
...
/* harmony import */ var system_format__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(7535);
/* harmony import */ var next_dynamic__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(5152);
/* harmony import */ var next_dynamic__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(next_dynamic__WEBPACK_IMPORTED_MODULE_8__);
/* harmony import */ var system_config_richtext__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(966);
...
/* harmony import */ var apis_utils_fetcher__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(6635);
/* harmony import */ var core_factory_fact_http__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(8894);
...
const AddItem = ({
  ...
  var _categories$rows, _subCategories$rows, _subCategories$rows$f, _subCategories$rows2, _subCategories$rows2$, _errors$title, _errors$parentCat, _errors$category, _errors$author_id, _errors$image, _errors$image2, _errors$text, _errors$text2;
  ...
  react__WEBPACK_IMPORTED_MODULE_0___default().useEffect(() => {
    if (dataValues !== null && dataValues !== void 0 && dataValues.id) {
  ...
  const subCategoryOptions = subCategories === null || subCategories === void 0 ? void 0 : (_subCategories$rows = subCategories.rows) === null || _subCategories$rows === void 0 ? void 0 : (_subCategories$rows$f = _subCategories$rows.filter(item => item.categoryId == getValues('parentCat'))) === null || _subCategories$rows$f === void 0 ? void 0 : _subCategories$rows$f.map(element => ({
    value: element.id,
    label: element.name
  }));
  const defaultSubCategoryOptions = subCategories === null || subCategories === void 0 ? void 0 : (_subCategories$rows2 = subCategories.rows) === null || _subCategories$rows2 === void 0 ? void 0 : (_subCategories$rows2$ = _subCategories$rows2.filter(item => item.id == (data === null || data === void 0 ? void 0 : data.category))) === null || _subCategories$rows2$ === void 0 ? void 0 : _subCategories$rows2$.map(item => ({
    value: item.id,
    label: item.name,
    categoryId: item.categoryId
  }));
  const defaultCategoryOptions = categoryOptions === null || categoryOptions === void 0 ? void 0 : categoryOptions.filter(item => {
    if (defaultSubCategoryOptions !== null && defaultSubCategoryOptions !== void 0 && defaultSubCategoryOptions.length) {
      return defaultSubCategoryOptions[0].categoryId == item.value;
    }

    return false;
  });
  const authorOptions = authors === null || authors === void 0 ? void 0 : authors.map(element => ({
    value: element.id,
    label: `${element.firstname} ${element.lastname}`
  }));
  const defaultAuthorOptions = authorOptions === null || authorOptions === void 0 ? void 0 : authorOptions.filter(item => item.value == (data === null || data === void 0 ? void 0 : data.author_id));
    ...
    children: [children, /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx("div", {
      ...
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsxs)("form", {
        ...
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsxs)("label", {
          ...
          })), ((_errors$title = errors.title) === null || _errors$title === void 0 ? void 0 : _errors$title.message) && /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx("p", {
          ...
          children: [/*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx("span", {
            ...
            className: "mt-2"
          })), ((_errors$parentCat = errors.parentCat) === null || _errors$parentCat === void 0 ? void 0 : _errors$parentCat.message) && /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx("p", {
            className: "mt-1 text-red-500",
          ...
          children: [/*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx("span", {
            ...
            className: "mt-2"
          })), ((_errors$category = errors.category) === null || _errors$category === void 0 ? void 0 : _errors$category.message) && /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx("p", {
            className: "mt-1 text-red-500",
          ...
          children: [/*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx("span", {
            ...
            className: "mt-2"
          })), ((_errors$author_id = errors.author_id) === null || _errors$author_id === void 0 ? void 0 : _errors$author_id.message) && /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx("p", {
            className: "mt-1 text-red-500",
          ...
          children: [/*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx("span", {
            ...
            multiple: false
          }), ((_errors$image = errors.image) === null || _errors$image === void 0 ? void 0 : _errors$image.message) && /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx("p", {
            className: "mt-1 text-red-500",
            children: (0,system_format__WEBPACK_IMPORTED_MODULE_14__/* .formatJoiErorr */ .a)(`${(_errors$image2 = errors.image) === null || _errors$image2 === void 0 ? void 0 : _errors$image2.message}`)
          })]
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsxs)("div", {
          className: "flex flex-col",
          children: [/*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx("p", {
            ...
            theme: "snow",
            defaultValue: data === null || data === void 0 ? void 0 : data.text,
          ...
          }), ((_errors$text = errors.text) === null || _errors$text === void 0 ? void 0 : _errors$text.message) && /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx("p", {
            className: "mt-1 text-red-500",
            children: (0,system_format__WEBPACK_IMPORTED_MODULE_14__/* .formatJoiErorr */ .a)(`${(_errors$text2 = errors.text) === null || _errors$text2 === void 0 ? void 0 : _errors$text2.message}`)
          })]
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsxs)("div", {
...
/* harmony import */ var _AddItem__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(2878);
...
/* harmony import */ var modules_admin_ArticleActivity__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(4685);
...
var __webpack_exports__ = __webpack_require__.X(0, [2922,3061,9531,5152,9682,967,8790,2077,3751,6133,9663,3903,3800,4108,6635,4427], () => (__webpack_exec__(3363)));
