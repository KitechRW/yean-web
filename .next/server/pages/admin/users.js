...
/* harmony import */ var apis_utils_fetcher__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(5377);
/* harmony import */ var modules_partials_Pagination__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(2862);
...
/* harmony import */ var modules_admin_Partials_ManageUsers_ViewUser__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(107);
      ...
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)("div", {
        ...
        children: /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx("table", {
          ...
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)("tbody", {
            ...
            }), data?.map(eachUser => /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx(modules_admin_Partials_ManageUsers_ViewUser__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .Z, {
              data: eachUser
...
const ViewUser = ({
  ...
  const update = (field, value) => {
    apis_restful__WEBPACK_IMPORTED_MODULE_3__/* ["default"].PatchRoute.patchRoute */ .Z.PatchRoute.patchRoute("/api/users/" + user?.id, {
      [field]: value
    }).then(response => {
      sweetalert__WEBPACK_IMPORTED_MODULE_4___default()('Updated!', response.data.message || 'Updated successfully', 'success').then(() => {
        setUser(_objectSpread({}, response.data?.data));
        setNewData(false);
      });
    });
  };
  ...
  const deleteUser = () => {
    sweetalert__WEBPACK_IMPORTED_MODULE_4___default()({
      ...
      apis_restful__WEBPACK_IMPORTED_MODULE_3__/* ["default"].DeleteRoute.deleteRoute */ .Z.DeleteRoute.deleteRoute("/api/users/" + user?.id).then(response => {
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("tr", {
    ...
    children: [/*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx("td", {
      ...
      children: newData ? /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx("button", {
        ...
        children: [!user?.active ? /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx("button", {
          onClick: () => {
            update("active", true);
          },
          type: "button",
...
/* harmony import */ var modules_admin_UsersActivity__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(6933);
...
var __webpack_exports__ = __webpack_require__.X(0, [676,3061,6945,4653,8844,9391,637,3389,2862], () => (__webpack_exec__(4458)));
