...
async function getServerSideProps({
  ...
  return core_factory_fact_http__WEBPACK_IMPORTED_MODULE_3__/* ["default"].axios.get */ .Z.axios.get(`${"http://test.yeanagro.org"}/api/articles?page=${pageNumber || 1}&limit=20`).then(resp => {
    return {
      props: {
        data: resp.data,
        status: resp.status
...
const BlogPage = props => {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    if (props.status === 404) {
      router.push('/404').then(r => console.log('navigate ' + JSON.stringify(r)));
    } else if (props.status === 500) {
      router.push('/500').then(r => console.log('navigate ' + JSON.stringify(r)));
    }
  }, []);
...
var __webpack_exports__ = __webpack_require__.X(0, [2922,3061,9682,967,2077,3751,3405,9055,3781,9663,4108,277,5834], () => (__webpack_exec__(6105)));
