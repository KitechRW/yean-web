...
/* harmony import */ var modules_partials_Logo__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(9682);
/* harmony import */ var next_link__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(1664);
/* harmony import */ var next_link__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(next_link__WEBPACK_IMPORTED_MODULE_8__);
/* harmony import */ var modules_partials_MetaData__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(3405);
  ...
  const onSubmit = data => {
    ...
    axios__WEBPACK_IMPORTED_MODULE_1___default().patch('/api/auth/reset-password', _objectSpread(_objectSpread({}, data), {}, {
      ...
      if (response.status === 201 || response.status === 200) {
        ...
        setMessage((response === null || response === void 0 ? void 0 : (_response$data = response.data) === null || _response$data === void 0 ? void 0 : _response$data.message) || 'reset successfully, go to login ');
        push('/login');
      } else {
...
var __webpack_exports__ = __webpack_require__.X(0, [2922,3061,9682,3405], () => (__webpack_exec__(4263)));
