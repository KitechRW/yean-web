...
function handler(req, res) {
  if (req.method === 'POST') {
    return apis_restful_controllers_AuthController__WEBPACK_IMPORTED_MODULE_0__/* ["default"].signUp */ .Z.signUp(req, res);
  } else {
...
var __webpack_exports__ = __webpack_require__.X(0, [1501,4115,5561,4367], () => (__webpack_exec__(2604)));
