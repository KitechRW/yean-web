...
/* harmony import */ var apis_restful_controllers_LibraryController__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6015);
...
function handler(req, res) {
  switch (req.method) {
    case 'GET':
      return apis_restful_controllers_LibraryController__WEBPACK_IMPORTED_MODULE_1__/* ["default"].getOne */ .Z.getOne(req, res);

    case 'PATCH':
      return apis_restful_controllers_LibraryController__WEBPACK_IMPORTED_MODULE_1__/* ["default"].update */ .Z.update(req, res);

    case 'DELETE':
      return apis_restful_controllers_LibraryController__WEBPACK_IMPORTED_MODULE_1__/* ["default"]["delete"] */ .Z["delete"](req, res);
...
var __webpack_exports__ = __webpack_require__.X(0, [8534,1501,4115,8494,6969,6015], () => (__webpack_exec__(4732)));
