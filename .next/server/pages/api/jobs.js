...
/* harmony import */ var apis_restful_controllers_JobController__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(9085);
...
function handler(req, res) {
  switch (req.method) {
    case 'GET':
      return apis_restful_controllers_JobController__WEBPACK_IMPORTED_MODULE_1__/* ["default"].getAll */ .Z.getAll(req, res);

    case 'POST':
      return apis_restful_controllers_JobController__WEBPACK_IMPORTED_MODULE_1__/* ["default"].create */ .Z.create(req, res);
...
var __webpack_exports__ = __webpack_require__.X(0, [8534,1501,4115,8494,9085], () => (__webpack_exec__(6001)));
