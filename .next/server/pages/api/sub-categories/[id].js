...
/* harmony import */ var apis_restful_controllers_SubCategoryController__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(9391);
...
function handler(req, res) {
  switch (req.method) {
    case 'GET':
      return apis_restful_controllers_SubCategoryController__WEBPACK_IMPORTED_MODULE_1__/* ["default"].getOne */ .Z.getOne(req, res);

    case 'PATCH':
      return apis_restful_controllers_SubCategoryController__WEBPACK_IMPORTED_MODULE_1__/* ["default"].update */ .Z.update(req, res);

    case 'DELETE':
      return apis_restful_controllers_SubCategoryController__WEBPACK_IMPORTED_MODULE_1__/* ["default"]["delete"] */ .Z["delete"](req, res);
...
var __webpack_exports__ = __webpack_require__.X(0, [8534,1075,6207,1547,3122,9391], () => (__webpack_exec__(9500)));
