  ...
  external_react_default().useEffect(() => {
    if (data?.data?.rows) {
      ...
      data?.data?.rows?.forEach((eachBook, index) => {
        ...
        // }
        setBooksPart1(previousBook => [...previousBook, eachBook]);
      });
    }
  }, [data]);
  return /*#__PURE__*/(0,jsx_runtime_.jsxs)(Scaffold/* default */.Z, {
    children: [/*#__PURE__*/(0,jsx_runtime_.jsxs)("div", {
      ...
      children: [/*#__PURE__*/jsx_runtime_.jsx(ReadBooks/* default */.Z, {
        ...
        className: "hidden w-full justify-center p-4 md:p-8 gap-3 items-center",
        children: [/*#__PURE__*/jsx_runtime_.jsx((image_default()), {
...
var __webpack_exports__ = __webpack_require__.X(0, [676,3061,6945,4653,8844,9391,637,3113,8805,253,2862,2881], () => (__webpack_exec__(2369)));
