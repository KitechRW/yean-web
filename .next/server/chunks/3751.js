...
class Open {
  ...
  async getRoute(endpoint, req) {
    return this.Server.get(endpoint, req).then(res => ({
      ...
      return {
        error: ((_err$response = err.response) === null || _err$response === void 0 ? void 0 : _err$response.data) || err.response || err
      };
    });
  }
  ...
  async postRoute(endpoint, req) {
    return this.Server.post(endpoint, req).then(res => ({
      ...
      return {
        error: ((_err$response2 = err.response) === null || _err$response2 === void 0 ? void 0 : _err$response2.data) || err.response || err
      };
    });
  }
...
var secureLs = __webpack_require__(1930);
...
var keys = __webpack_require__(3932);
