...
var NavItems = __webpack_require__(4949);
...
;// CONCATENATED MODULE: ./src/modules/_partials/Transition/index.tsx
...
const TransitionContext = /*#__PURE__*/external_react_default().createContext({
  parent: {}
});
...
function CSSTransition(_ref) {
  ...
  return /*#__PURE__*/jsx_runtime_.jsx(external_react_transition_group_.CSSTransition, {
    ...
    children: /*#__PURE__*/jsx_runtime_.jsx(Component, _objectSpread(_objectSpread({
      ref: nodeRef
    }, rest), {}, {
      style: {
...
function Transition(_ref2) {
  ...
  const {
    parent
  } = (0,external_react_.useContext)(TransitionContext);
  const isInitialRender = useIsInitialRender();
  const isChild = show === undefined;

  if (isChild) {
    return /*#__PURE__*/jsx_runtime_.jsx(CSSTransition, _objectSpread({
      appear: parent.appear || !parent.isInitialRender,
      show: parent.show
    }, rest));
  }

  return /*#__PURE__*/jsx_runtime_.jsx(TransitionContext.Provider, {
    value: {
      parent: {
        show,
        isInitialRender,
    ...
    children: /*#__PURE__*/jsx_runtime_.jsx(CSSTransition, _objectSpread({
      appear: appear,
      show: show
    }, rest))
  });
...
/* harmony default export */ const _partials_Transition = (Transition);
...
function SearchModal({
  ...
  return /*#__PURE__*/(0,jsx_runtime_.jsxs)(jsx_runtime_.Fragment, {
    children: [/*#__PURE__*/jsx_runtime_.jsx(_partials_Transition, {
      ...
      leaveEnd: "opacity-0",
      "aria-hidden": "true"
    }), /*#__PURE__*/jsx_runtime_.jsx(_partials_Transition, {
      id: id,
...
const Footer = () => {
  ...
  const onSubmit = async event => {
    ...
    if (!email.trim()) {
      setErrors(prev => Footer_objectSpread(Footer_objectSpread({}, prev), {}, {
  ...
  return /*#__PURE__*/(0,jsx_runtime_.jsxs)(jsx_runtime_.Fragment, {
    children: [/*#__PURE__*/jsx_runtime_.jsx((Snackbar_default()), {
      ...
      onClose: () => setOpen(prev => Footer_objectSpread(Footer_objectSpread({}, prev), {}, {
        open: false
      })),
