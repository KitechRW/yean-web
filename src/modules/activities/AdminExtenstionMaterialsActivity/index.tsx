...
const AdminExtenstionMaterialsActivity = () => {
  ...
  const [extensionMaterialsList, setExtensionMaterialsList] = useState<any[]>([]);
      ...
      <div>
        <section>
          ...
          <ul className="bg-slate-50 p-4 sm:px-8 sm:pt-6 sm:pb-8 lg:p-4 xl:px-8 xl:pt-6 xl:pb-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 text-sm leading-6">
            {extensionMaterialsList.map((eachPartner, index) => {
              return (
                <PartnerAdminView
                  key={eachPartner.id}
                  data={eachPartner}
...
export default AdminExtenstionMaterialsActivity
