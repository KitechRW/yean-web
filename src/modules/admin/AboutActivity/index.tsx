...
import AddItem from '../_Partials/ManageAbout/AddItem';
import ViewItem from '../_Partials/ManageAbout/ViewItem';

const AboutActivity = () => {
  const [about, setData] = React.useState<any[]>([]);
  const {
    data: { data },
    isLoading,
    isError,
  ...
  const matchabout = about.filter((element: any) => {
