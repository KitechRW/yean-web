...
import AddItem from '../_Partials/ManagePartner/AddItem';
import ViewItem from '../_Partials/ManagePartner/ViewItem';
...
const PartnerActivity = () => {
  ...
  React.useEffect(() => {
    ...
    if (rows.length) {
      const matchpartners = rows.filter((element: any) =>
        element.companyName?.toLowerCase()?.includes(filterValue.toLowerCase()),
      );
      setPartners(prev => ({ ...prev, rows: matchpartners }));
    }
  }, [data, filterValue]);
