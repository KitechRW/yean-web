...
import AddItem from '../_Partials/ManageTeam/AddItem';
import ViewItem from '../_Partials/ManageTeam/ViewItem';

const TeamActivity = () => {
  const [team, setData] = React.useState<any[]>([]);
  const {
    data: { data },
    isLoading,
    isError,
  ...
  const matchteam = team.filter((element: any) => {
