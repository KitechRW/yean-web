...
import AddItem from '../_Partials/ManageProject/AddItem';
import ViewItem from '../_Partials/ManageProject/ViewItem';
...
const ProjectActivity = () => {
  ...
  React.useEffect(() => {
    ...
    if (rows.length) {
      const matchprojects = rows.filter((element: any) =>
        element.name
          .toLowerCase()
          .includes(filterValue.toLowerCase()),
      );
      setData(prev => ({ ...prev, rows: matchprojects }));
    }
  }, [data, filterValue]);
